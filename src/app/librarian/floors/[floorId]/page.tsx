...
export default async function LibrarianFloorDetailPage({
  params,
}: PageProps<"/librarian/floors/[floorId]">) {
  ...
  return (
    <div>
      <Link href="/librarian" className="text-sm text-neutral-500 hover:underline">
        ← Overview
      </Link>
